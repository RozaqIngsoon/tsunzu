...
class Bab6_1 extends StatelessWidget {
  const Bab6_1({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureKu(
        onSwipeKiri: () => Get.to(() => Bab6_0() ,transition: Transition.leftToRight, duration: Duration(seconds: 1),),
        onSwipeKanan: ()=> Get.to(() => Bab6_2(),transition: Transition.rightToLeft, duration: Duration(seconds: 1),),
        child: Container(
