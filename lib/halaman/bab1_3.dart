    ...
    return GestureDetector(
      ...
      onHorizontalDragUpdate: (detail) {
        ...
        if(detail.delta.direction<=0){
          Get.to(() =>  Bab1_2(),transition: Transition.leftToRight, duration: Duration(seconds: 1),);
        }
        //ke kanan
        if(detail.delta.direction>0){
          Get.to(() => Bab1_4(),transition: Transition.rightToLeft, duration: Duration(seconds: 1),);
        }
      },
      child: Scaffold(
        body: Container(
