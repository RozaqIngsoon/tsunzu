...
class Bab10_1 extends StatelessWidget {
  const Bab10_1({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:  GestureKu(
        onSwipeKiri: () => Get.to(() => Bab10_0() ,transition: Transition.leftToRight, duration: Duration(seconds: 1),),
        onSwipeKanan: ()=> Get.to(() => Bab10_2(),transition: Transition.rightToLeft, duration: Duration(seconds: 1),),
