...
class Bab5_1 extends StatelessWidget {
  const Bab5_1({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureKu(
        onSwipeKiri: () => Get.to(() => Bab5_0() ,transition: Transition.leftToRight, duration: Duration(seconds: 1),),
        onSwipeKanan: ()=> Get.to(() => Bab5_2(),transition: Transition.rightToLeft, duration: Duration(seconds: 1),),
        child: Container(
