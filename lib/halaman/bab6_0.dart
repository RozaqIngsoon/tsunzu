...
class Bab6_0 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureKu(
      onSwipeKiri: () => Get.to(() => Bab5_6() ,transition: Transition.leftToRight, duration: Duration(seconds: 1),),
      onSwipeKanan: ()=> Get.to(() => Bab6_1(),transition: Transition.rightToLeft, duration: Duration(seconds: 1),),
      child: Scaffold(
        body: Container(
