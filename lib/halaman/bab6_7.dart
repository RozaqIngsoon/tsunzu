...
class Bab6_7 extends StatelessWidget {
  const Bab6_7({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureKu(
        onSwipeKiri: () => Get.to(() =>  Bab6_6(),transition: Transition.leftToRight, duration: Duration(seconds: 1),),
        onSwipeKanan: ()=> Get.to(() =>Bab6_8() ,transition: Transition.rightToLeft, duration: Duration(seconds: 1),),
        child: Container(
