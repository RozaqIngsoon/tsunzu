...
class Bab13_0 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  GestureKu(
      onSwipeKiri: () => Get.to(() =>  Bab12_5(),transition: Transition.leftToRight, duration: Duration(seconds: 1),),
      onSwipeKanan: ()=> Get.to(() => Bab13_1(),transition: Transition.rightToLeft, duration: Duration(seconds: 1),),
