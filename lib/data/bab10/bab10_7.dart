Map bab10_7 = {
   'bab10_7' :'''
### mengetahuinya atau tidak mengamalkannya kemungkinan besar akan kalah dalam pertempuran.
...
### Perlakukan tentaramu seperti anak-anakmu, dan mereka akan mengikutimu ke lembah terdalam; pandanglah mereka sebagai putra-putramu yang tercinta, dan mereka akan tetap setia 
'''
};