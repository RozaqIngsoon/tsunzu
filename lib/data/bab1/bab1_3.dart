Map bab1_3 = {
  'bab1_3': '''
### siapa yang mengenalinya akan meraih kemenangan; siapa yang tidak mengenalinya akan gagal. Oleh karena itu, dalam pertimbangan kamu, ketika berusaha menentukan kondisi militer, gunakan prinsip tersebut sebagai dasar perbandingan, seperti ini:
...
### g).	Di dalam pasukan manakah terdapat konsistensi yang lebih besar baik dalam 
'''
};